...
namespace Trady.Importer.AlphaVantageFx
{
    public class AlphaVantageFxImporter : IImporter
    {
        public AlphaVantageFxImporter(string apiKey, OutputSize outputSize = OutputSize.compact)
        {
            ApiKey = apiKey;
